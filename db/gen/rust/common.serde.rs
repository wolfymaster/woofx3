...
impl serde::Serialize for ResponseStatus {
        ...
        S: serde::Serializer,
    {
        ...
        if self.code != 0 {
            let v = response_status::Code::from_i32(self.code)
...
impl<'de> serde::Deserialize<'de> for ResponseStatus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<ResponseStatus, V::Error>
                where
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::Code => {
                            ...
                            code__ = Some(map.next_value::<response_status::Code>()? as i32);
                        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                ...
                i32::try_from(v)
                    .ok()
                    .and_then(response_status::Code::from_i32)
                    .ok_or_else(|| {
