...
impl<'de> serde::Deserialize<'de> for ClearAllForApplicationRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<ClearAllForApplicationRequest, V::Error>
                where
...
impl<'de> serde::Deserialize<'de> for ClearAllForApplicationResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<ClearAllForApplicationResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for ClearExpiredRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<ClearExpiredRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut application_id__ = None;
...
impl<'de> serde::Deserialize<'de> for ClearExpiredResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<ClearExpiredResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
...
impl<'de> serde::Deserialize<'de> for ClearNamespaceRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<ClearNamespaceRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for ClearNamespaceResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<ClearNamespaceResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
...
impl<'de> serde::Deserialize<'de> for SetRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<SetRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut item__ = None;
...
impl<'de> serde::Deserialize<'de> for SetResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<SetResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
...
impl<'de> serde::Deserialize<'de> for StorageItem {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<StorageItem, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::ClearOnStreamEnd => {
                            ...
                            clear_on_stream_end__ = Some(map.next_value()?);
                        }
                    }
                }
                Ok(StorageItem {
