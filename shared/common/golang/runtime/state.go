...
const (
	...
	EventHealthMonitorReady      Event = "HEALTH_MONITOR_READY"
	EventHealthMonitorFailed     Event = "HEALTH_MONITOR_FAILED"
	...
	EventAllServicesDisconnected Event = "ALL_SERVICES_DISCONNECTED"
