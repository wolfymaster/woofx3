...
*/
        pub async fn ping(
            ...
            req.extensions_mut().insert(GrpcMethod::new("common.CommonService", "Ping"));
...
*/
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("common.CommonService", "MigrationStatus"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/common.CommonService/MigrationStatus" => {
                    #[allow(non_camel_case_types)]
                    struct MigrationStatusSvc<T: CommonService>(pub Arc<T>);
                    impl<
                        T: CommonService,
                    ...
                    for MigrationStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CommonService>::migration_status(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "common.CommonService";
