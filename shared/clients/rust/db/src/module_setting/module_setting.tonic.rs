...
pub mod module_setting_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ///
        pub async fn get_module_secret_values(
            &mut self,
            request: impl tonic::IntoRequest<super::GetModuleSecretValuesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetModuleSecretValuesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod module_setting_service_server {
    ...
    pub trait ModuleSettingService: std::marker::Send + std::marker::Sync + 'static {
        ...
        >;
        ///
        async fn get_module_secret_values(
            &self,
            request: tonic::Request<super::GetModuleSecretValuesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetModuleSecretValuesResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/module_setting.ModuleSettingService/GetModuleSecretValues" => {
                    #[allow(non_camel_case_types)]
                    struct GetModuleSecretValuesSvc<T: ModuleSettingService>(pub Arc<T>);
                    impl<
                        T: ModuleSettingService,
                    > tonic::server::UnaryService<super::GetModuleSecretValuesRequest>
                    for GetModuleSecretValuesSvc<T> {
                        type Response = super::GetModuleSecretValuesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ModuleSettingService>::get_module_secret_values(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetModuleSecretValuesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
