...
pub mod application_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("application.ApplicationService", "GetApplication"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("application.ApplicationService", "ListApplications"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod application_service_server {
    ...
    #[async_trait]
    pub trait ApplicationService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct ApplicationServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> ApplicationServiceServer<T> {
        pub fn new(inner: T) -> Self {
                ...
                "/application.ApplicationService/CreateApplication" => {
                    ...
                    for CreateApplicationSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ApplicationService>::create_application(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/application.ApplicationService/GetApplication" => {
                    ...
                    for GetApplicationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ApplicationService>::get_application(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/application.ApplicationService/UpdateApplication" => {
                    ...
                    for UpdateApplicationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ApplicationService>::update_application(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/application.ApplicationService/DeleteApplication" => {
                    ...
                    for DeleteApplicationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ApplicationService>::delete_application(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T> Clone for ApplicationServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "application.ApplicationService";
    impl<T> tonic::server::NamedService for ApplicationServiceServer<T> {
