...
func (x *Trigger) GetTransport() string {
	if x != nil {
		return x.Transport
	}
	return ""
...
func (x *Trigger) GetHandler() string {
	if x != nil {
		return x.Handler
	}
	return ""
...
func (x *TriggerInput) GetTransport() string {
	if x != nil {
		return x.Transport
	}
	return ""
...
func (x *RegisterTriggersRequest) GetModuleId() string {
	if x != nil {
		return x.ModuleId
	}
	return ""
