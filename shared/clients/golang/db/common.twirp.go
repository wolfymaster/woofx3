...
func NewCommonServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) CommonService {
...
func (c *commonServiceProtobufClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
...
func (c *commonServiceProtobufClient) callPing(ctx context.Context, in *PingRequest) (*PingResponse, error) {
...
func NewCommonServiceJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) CommonService {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *commonServiceJSONClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "common")
	ctx = ctxsetters.WithServiceName(ctx, "CommonService")
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	caller := c.callPing
...
// NewCommonServiceServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewCommonServiceServer(svc CommonService, opts ...interface{}) TwirpServer {
...
func (s *commonServiceServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// CommonServicePathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const CommonServicePathPrefix = "/twirp/common.CommonService/"
...
func (s *commonServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "common.CommonService" {
...
func (s *commonServiceServer) servePing(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *commonServiceServer) servePingJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
		...
		handler = func(ctx context.Context, req *PingRequest) (*PingResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.CommonService.Ping(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*PingResponse)
...
func (s *commonServiceServer) servePingProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *commonServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "common", "CommonService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
