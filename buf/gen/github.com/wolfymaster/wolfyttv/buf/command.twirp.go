...
func (c *commandServiceProtobufClient) GetCommands(ctx context.Context, in *GetCommandsRequest) (*GetCommandsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "wolfyttv.event")
	ctx = ctxsetters.WithServiceName(ctx, "CommandService")
	ctx = ctxsetters.WithMethodName(ctx, "GetCommands")
	caller := c.callGetCommands
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetCommandsRequest) (*GetCommandsResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetCommandsRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*GetCommandsRequest) when calling interceptor")
					}
					return c.callGetCommands(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetCommandsResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*GetCommandsResponse) when calling interceptor")
				}
...
func (c *commandServiceProtobufClient) callGetCommands(ctx context.Context, in *GetCommandsRequest) (*GetCommandsResponse, error) {
...
func (c *commandServiceJSONClient) GetCommands(ctx context.Context, in *GetCommandsRequest) (*GetCommandsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "wolfyttv.event")
	ctx = ctxsetters.WithServiceName(ctx, "CommandService")
	ctx = ctxsetters.WithMethodName(ctx, "GetCommands")
	caller := c.callGetCommands
...
const CommandServicePathPrefix = "/twirp/wolfyttv.event.CommandService/"
...
func (s *commandServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "wolfyttv.event.CommandService" {
...
func (s *commandServiceServer) serveGetCommands(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveGetCommandsJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetCommandsProtobuf(ctx, resp, req)
	default:
...
func (s *commandServiceServer) serveGetCommandsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetCommands")
	...
	reqContent := new(GetCommandsRequest)
	...
	handler := s.CommandService.GetCommands
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetCommandsRequest) (*GetCommandsResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.CommandService.GetCommands(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetCommandsResponse)
	...
	// Call service method
	var respContent *GetCommandsResponse
	func() {
...
func (s *commandServiceServer) serveGetCommandsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetCommands")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *commandServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "wolfyttv.event", "CommandService")
}
