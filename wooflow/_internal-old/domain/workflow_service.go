...
type WorkflowService struct {
	repo core.WorkflowDefinitionRepository
}

// NewWorkflowService creates a new workflow service
func NewWorkflowService(repo core.WorkflowDefinitionRepository) *WorkflowService {
...
func (s *WorkflowService) CreateWorkflowDefinition(ctx context.Context, def *core.WorkflowDefinition) error {
...
func (s *WorkflowService) GetWorkflowDefinition(ctx context.Context, id string) (*core.WorkflowDefinition, error) {
	return s.repo.GetWorkflowDefinitionByID(ctx, id)
}

// UpdateWorkflowDefinition updates an existing workflow definition
func (s *WorkflowService) UpdateWorkflowDefinition(ctx context.Context, def *core.WorkflowDefinition) error {
	if err := s.validateWorkflowDefinition(def); err != nil {
		return fmt.Errorf("invalid workflow definition: %w", err)
	}
...
func (s *WorkflowService) ListWorkflowDefinitions(ctx context.Context, filter *core.WorkflowDefinitionFilter) ([]*core.WorkflowDefinition, error) {
	return s.repo.QueryWorkflowDefinitions(ctx, filter)
}

// validateWorkflowDefinition validates a workflow definition
func (s *WorkflowService) validateWorkflowDefinition(def *core.WorkflowDefinition) error {
	if def.ID == "" {
