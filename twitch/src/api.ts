...
//   const onChannelSubscriptionMessage = listener.onChannelSubscriptionMessage(
//     userId,
//     async (event: EventSubChannelSubscriptionMessageEvent) => {
...
//   const onChannelRedemptionAdd = listener.onChannelRedemptionAdd(
//     userId,
//     async (evt: EventSubChannelRedemptionAddEvent) => {
...
//   const onChannelChatNotification = listener.onChannelChatNotification(
//     broadcaster,
//     broadcaster,
//     (evt: EventSubChannelChatNotificationEvent) => {
